...
#include "disc/disc_sys.c"		/* discrete core modules and support functions */
#include "disc/disc_wav.c"		/* Wave sources   - SINE/SQUARE/NOISE/etc */
#include "disc/disc_mth.c"		/* Math Devices   - ADD/GAIN/etc */
#include "disc/disc_inp.c"		/* Input Devices  - INPUT/CONST/etc */
#include "disc/disc_flt.c"		/* Filter Devices - RCF/HPF/LPF */
#include "disc/disc_dev.c"		/* Popular Devices - NE555/etc */
